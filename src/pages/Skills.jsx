...
function Skills() {
  return (
    <section
      id="skills"
      className="min-h-[80vh] sm:min-h-auto px-44 py-12 flex flex-col items-center justify-center"
    >
      ...
      <div className="lg:w-full flex lg:flex-row sm:flex-row lg:flex-wrap flex-col gap-6 lg:justify-evenly md:mb-5">
        <div className="p-6 w-[350px] sm:w-[280px] rounded-[10px] text-center relative bg-[#eadcc2] touch-manipulation after:bg-[#333] after:rounded-[10px] after:block after:-right-[7px] after:h-full after:w-full after:absolute after:-bottom-[7px] after:transform after:translate-x-[7px] after:translate-y-[7px] after:-z-1">
